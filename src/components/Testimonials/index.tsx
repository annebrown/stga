...
const Testimonials = () => {
  return (
    <>
    <div className=" bg-green-200 relative z-10 pt-7 pb-2 rounded-lg mt-10 mr-2 mb-5">
      <h1 className="text-3xl font-bold text-center pb-5 text-black">
        Local Voices
      </h1>
      <p className="text-center pb-7 text-black">What members of the community are saying about the proposed development:</p>
