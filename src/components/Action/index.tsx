      ...
      <section id="Action" className="realtive z-30 mt-0 p-0 w-full text-black">
        ...
        <div className="pb-10 grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 md:gap-x-6 lg:gap-x-8 xl:grid-cols-3">
            ...
            <div className="w-full">
                <h2 className="">SPREAD THE WORD</h2>
            ...
            <div className="w-full">
                ...
                <div className="p-1 bg-[#fbbf24] text-black">
                    WARNING: Donations to change.org DO NOT go towards our cause.  For donations to STGA, please use Interac E-Transfer to savethegroveagain@gmail.com.
                </div>
