  ...
  return (
    <>
      <a
        ...
        className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light text-body-color duration-300 hover:bg-primary hover:text-white sm:ml-3"
      >
        <svg
          width="16"
          height="16"
      ...
      <a
        href="#0"
        aria-label="social-share"
        className="mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light text-body-color duration-300 hover:bg-primary hover:text-white"
      >
        <svg
          width="18"
          height="18"
