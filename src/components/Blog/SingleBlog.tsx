  ...
  return (
    <>
      <div className="group relative overflow-hidden rounded-sm bg-white shadow-one duration-300 hover:shadow-two w-full h-full">
        ...
        >
          <span className="absolute right-1 bottom-1 z-20 inline-block  items-center justify-center rounded-full bg-primary/100 px-4 py-2 text-sm font-semibold capitalize text-black">
            {tags[0]}
          </span>
          <Image 
            src={image} 
