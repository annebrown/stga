            ...
            <div className="mx-auto w-full px-4 md:w-8/12 lg:w-8/12 justify-center">
                ...
                <div className="mb-5 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4">
                    ...
                    <p class="mb-8 text-center italic">
                        ...
                        <span class="underline">The Pines by Ruby Archer</span> <br />
                    </p>
                    ...
                    <p className="mb-8 text-center">
                        Watch and Share our YouTube video <a href="https://www.youtube.com/embed/tEgtT1LX-Sk" class="duration-300 hover:text-primary text-[#38AF34]">What’s at Stake</a>
                    </p>
                    <p className="mb-8">
                    ...
                    <p class="bg-orange-400 p-2">Consider Moving to separate blog page because, literally burying the headline.  lol</p>
                    <p className="mb-8">Latest News and Stories:</p>
                    <p class="bg-orange-400 p-2">Or continue here</p>
