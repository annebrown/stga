            ...
            >
                <div className="mb-5 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4">
                    ...
                    <p className="text-2xl">
                        <strong>Community Meeting</strong>
                    </p><br></br>
                    <p 
                    ...
                    <p className="mb-8">
                        ...
                        <ul className="mb-8">
                            ...
                            <li>💚 Subscribe to our mailing list here</li>
                            <li>💚 Fill out our volunteer form here</li>
                            <li>💚 Like and follow our Facebook page here</li>
                            <li>💚 Subscribe to our Youtube channel here</li>
                            <li>💚 Make a donation via e-transfer to savethegroveagain@gmail.com</li>
                        </ul>
                        <p className="mb-8">
                        ...
                        <p className="font-extrabold text-red-500">
                            "Maybe trees have a right to sometimes grow old.”</p>
