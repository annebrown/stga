        ...
        <div className="container">
            ...
            >
                <div className="mb-5 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4">
                    ...
                    Today is election day in the province of Ontario so, if you haven’t already, get out and vote. You can find out all the details from the <a className="text-[#165D8F]" href="https://voterinformationservice.elections.on.ca/en/election/search?mode=electoralDistrict">Elections Ontario Voter Information Service</a>.
                    </p>
                    ...
                    <p className="mb-8 text-center italic text-lg leading-5">
