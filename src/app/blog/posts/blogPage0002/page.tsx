                    ...
                    <div className="-mx-4 flex flex-wrap justify-center">
                        <div className="w-full px-4 lg:w-8/12">
                            ...
                            <div className="text-center px-20">
                                ...
                                <p className="text-left py-2">
                                    Subscribe to our <a className="text-green-600" href="https://docs.google.com/forms/d/e/1FAIpQLSfBFJHDmUnmpGv1XaSHGaSSPmGizbxrQ-KgeqRRZqdVNZeuHg/viewform">mailing list</a> to get the latest updates, announcements and events
                                </p>
                                <p className="text-left py-2">
                                ...
                                <p className="text-left py-2">
                                    Take a moment to sign the <a className="text-green-600"  href="https://www.change.org/p/save-the-grove-again-7292e6ca-eb8e-426a-8809-0bb608f24120">online petition</a> (please note that donations through change.org do not come directly to our cause, please send an e-transfer to&nbsp;
