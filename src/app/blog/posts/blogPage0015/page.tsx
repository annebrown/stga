        ...
        <div className="container">
            ...
            >
                <div className="mb-5 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4">
                    ...
                    <p className="mb-8  text-justify">
                    Let&apos;s continue this call for council to conduct a thorough ecological assessment! Join our postcard campaign and send your thoughts to the Town of Arnprior. More info <Link href="https://savethegroveagain.com/blog/posts/blogPage0013" className="text-green-600">here</Link>. 
                    </p>
